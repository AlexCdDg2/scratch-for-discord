...
const blockName = "gsa_set_embed_author";
  const BORDER_FIELDS = ["NAME", "URL", "ICONURL"];
const BORDER_TYPES = ["String","String","String"];
const names = ["name", "url", "pfp"];
const amountOfInputs = names.length
const menuName = 'idk'


const blockData = {
    "message0": "set embed author",
    "colour": 120,
...
Blockly.JavaScript[blockName] = function (block) {
  ...
  const icon_url = Blockly.JavaScript.valueToCode(block, "ICONURL", Blockly.JavaScript.ORDER_NONE)
